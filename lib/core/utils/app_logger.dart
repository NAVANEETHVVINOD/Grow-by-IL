...
class AppLogger {
  ...
  static void info(LogCategory category, String msg, [Map<String, dynamic>? data]) {
    _log(category, 'INFO', msg, data);
  }

  static void warn(LogCategory category, String msg, [Map<String, dynamic>? data]) {
    _log(category, 'WARN', msg, data);
  }

  static void success(LogCategory category, String msg, [Map<String, dynamic>? data]) {
    _log(category, 'SUCCESS', msg, data);
  }

  static void action(LogCategory category, String act, [Map<String, dynamic>? data]) {
    _log(category, 'ACTION', act, data);
  }

  static void error(LogCategory category, String msg, {Object? error, StackTrace? stack, Map<String, dynamic>? data}) {
  ...
  static void _log(LogCategory cat, String level, String msg, Map<String, dynamic>? data) {
    final extra = _formatData(data);
